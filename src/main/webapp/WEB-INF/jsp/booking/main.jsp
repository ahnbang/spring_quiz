			...
			<nav>
                <ul class="nav nav-fill">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link text-white font-weight-bold">객실보기</a></li>
                   	<li class="nav-item"><a href="/lesson06/quiz03/2" class="nav-link text-white font-weight-bold">예약하기</a></li>
                    <li class="nav-item"><a href="/lesson06/quiz03/1" class="nav-link text-white font-weight-bold">예약목록</a></li>
                </ul>
            </nav>
            <section class="banner bg-info">
                <img id="bannerImage" src="/img/test06_banner1.jpg" alt="banner" width="1110px" height="500px">
            </section>
                ...
                <section class="confirm col-4">
                    ...
                    <div id="memberInputBox" class="m-2">
                        ...
                        <div class="text-right mt-3 mr-3">
                            <button type="button" class="btn btn-success submit-btn" id="submitBtn">조회 하기</button>
                        </div>
                    </div>
